...
const cbcFields = [
  { label: "Haemoglobin", id: "hb", unit: "g/dL", range: "13.0 - 17.0", method: "Cyan-methhemoglobin" },
  { label: "RBC Count", id: "rbc", unit: "million/µL", range: "4.50 - 5.50", method: "Light scatter" },
  { label: "PCV", id: "pcv", unit: "%", range: "40 - 52", method: "Mathematical Calculation" },
  { label: "MCV", id: "mcv", unit: "fL", range: "83 - 101", method: "RBC Histogram" },
  { label: "MCH", id: "mch", unit: "pg", range: "27 - 32", method: "Mathematical Calculation" },
  { label: "MCHC", id: "mchc", unit: "g/dL", range: "31.0 - 37.0", method: "Mathematical Calculation" },
  { label: "RDW", id: "rdw", unit: "%", range: "11.5 - 14.5", method: "RBC Histogram" },
  { label: "Total Leucocyte Count", id: "tlc", unit: "cells/µL", range: "4000 - 10000", method: "Peroxidase/Basophil" }
];

// ========= DIFFERENTIAL LEUCOCYTE COUNT (DLC) =========
const dlcFields = [
  { label: "Neutrophils", id: "neutrophils", unit: "%", range: "40 - 75", method: "Light scatter" },
  { label: "Absolute Neutrophil Count", id: "anc", unit: "/µL", range: "2000 - 7000", method: "Flowcytometry" },
  { label: "Lymphocytes", id: "lymphocytes", unit: "%", range: "20 - 45", method: "Light scatter" },
  { label: "Absolute Lymphocyte Count", id: "alc", unit: "/cu mm", range: "1500 - 4000", method: "Light scatter" },
  { label: "Monocytes", id: "monocytes", unit: "%", range: "01 - 10", method: "Light scatter" },
  { label: "Absolute Monocyte Count", id: "amc", unit: "/cu mm", range: "200 - 800", method: "Light scatter" },
  { label: "Eosinophils", id: "eosinophils", unit: "%", range: "01 - 06", method: "Light scatter" },
  { label: "Absolute Eosinophil Count", id: "aec", unit: "/cu mm", range: "40 - 440", method: "Light scatter" },
  { label: "Basophils", id: "basophils", unit: "%", range: "00 - 01", method: "Light scatter" },
  { label: "Absolute Basophil Count", id: "abc", unit: "/µL", range: "20 - 100", method: "Flowcytometry" },
  { label: "Platelet Count", id: "platelets", unit: "cells/µL", range: "150000 - 450000", method: "Light scatter" },
  { label: "PCT", id: "pct", unit: "%", range: "0.19 - 0.39", method: "Mathematical Calculation" },
  { label: "MPV", id: "mpv", unit: "fL", range: "6.8 - 10.9", method: "Platelet Histogram" }
];

// Collect entered CBC rows
const cbcRows = cbcFields
  .map(f => {
    const val = document.getElementById(f.id)?.value;
    if (!val) return null;
    return [f.label, val, f.unit, f.range, f.method];
  })
  .filter(Boolean);

// Collect entered DLC rows
...
if (cbcRows.length || dlcRows.length) {
  ...
  // DLC heading
  if (dlcRows.length) {
    const dlcStartY = doc.lastAutoTable.finalY + 8;

    doc.setFontSize(9);
    doc.setFont(undefined, "italic");
    doc.text("DIFFERENTIAL LEUCOCYTE COUNT (DLC)", 15, dlcStartY);
    doc.setFont(undefined, "normal");
