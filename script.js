...
if (uricAcid) {
  ...
  // ---- COMMENT BOX (IMPROVED LAYOUT) ----
const commentStartY = doc.lastAutoTable.finalY + 4;

// Box dimensions
const commentBoxX = 15;
const commentBoxWidth = pageWidth - 30;
const commentBoxHeight = 62;

// Draw outer box
doc.rect(commentBoxX, commentStartY + 2, commentBoxWidth, commentBoxHeight);

// Title
doc.setFontSize(9);
doc.text("Comment:", commentBoxX + 3, commentStartY + 8);
...
doc.text(
  ...
  commentBoxX + commentBoxWidth - 58,
  commentStartY + 14
);

currentY = commentStartY + commentBoxHeight + 8;
} // END uricAcid section
